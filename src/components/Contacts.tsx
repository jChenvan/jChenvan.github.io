export default function Contacts() {
    return <section className='flex flex-col shadow-lg shadow-black bg-gray-900 text-white rounded-lg m-6 items-center overflow-hidden' id="contacts">
          <h2 className='text-4xl text-center self-stretch p-4 bg-purple-950'>Contacts</h2>
