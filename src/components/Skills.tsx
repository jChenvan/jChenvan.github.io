...
export default function Skills () {
    return <section className='flex flex-col items-center shadow-lg shadow-black rounded-lg overflow-hidden pb-4 m-6 bg-gray-900 text-white' id="skills">
          ...
          <p className='text-center my-4 mx-2'>Through my time in University, as well as online coding resources like The <a href="https://www.theodinproject.com/">Odin Project</a>, I have become proficient in the many facets of web development. </p>
          <div style={{gridTemplateColumns: 'auto 20ch'}} className='grid items-center gap-y-4 gap-x-10 bg-black p-6 rounded-md mx-2'>
